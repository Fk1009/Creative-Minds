		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div class="col-md-5">
					...
					<p class="pb-4">You can also reach out to us by phone
						or email are many variations</p>
					<div class="contact-box mb-4">
						<div class="d-flex p-3 bg-light-blue align-items-center">
							...
							<div class="text">
								...
								<p class="telephone">Call : <a href="tel:12345 67890">+12345 67890</a></p>
							</div>
						</div>
					</div>
					<div class="contact-box mb-4">
						<div class="d-flex p-3 bg-light-blue align-items-center">
							...
							<div class="text">
								...
								<p class="telephone">Mail : <a href="mailto:xyz@gmail.com">+xyz@gmail.com</a></p>
							</div>
						</div>
					</div>
