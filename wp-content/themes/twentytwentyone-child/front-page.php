		...
		<div class="row align-items-center h-100">
			<div class="col-md-6">
				<div class="d-none d-md-none d-sm-block">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assest/image/startup-image.png">
				</div>
			</div>
			<div class="col-md-6">
				<?php
		...
		<div class="container">
			...
			<div class="row align-items-center">
				...
				foreach ($serviceItemSection as $value) { 
					...
					<div class="col-md-4">
						<div class="service-box md-mb-2">
							<img class="icon w-100" src="<?php echo $serviceImgSrc; ?>" alt="<?php echo $serviceImgAlt; ?>" title="<?php echo $serviceName; ?>" />
...
if(!empty($servicePosts)){ ?>
	<section class="section-service-area pb-80 pt-80" data-aos="fade-up" data-aos-duration="1500">
		<div class="container right-container">
			<div class="d-flex mobile-serve-sec align-items-start" data-aos="fade-right" data-aos-duration="1500">
				<div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<h2 class="text-white"><?php echo $ourServicesHeading; ?></h2>
					<p class="text-white mb-5 md-mb-2 text-uppercase"><?php echo $ourServicesSubHeading; ?></p>
					<div class="btn-sec">
					<?php
					$count = 1;
...
<section class="requitment-process pb-80 pt-80" data-aos="fade-up" data-aos-duration="1500">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<h2 data-aos="fade-right" data-aos-duration="1500" class="theme-red-font md-mb-2">
